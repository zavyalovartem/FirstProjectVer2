...
class Level_3_Handler:
    def __init__(self, player_id, message, bot):
        global scenes
        global tasks
        path = os.getcwd() + "/JsonScenes"
        with open(path + "/Tasks_Level_3.json", encoding="utf-8") as f:
            tasks = json.loads(f.read())
        with open(path + "/Scenes_Level_3.json", encoding="utf-8") as f:
    ...
    def handle_start(self):
        ...
        self.bot.send_photo(self.message.chat.id, "AgACAgIAAxkDAAIFy17NAs8IhZqAXCaLrR-0sHMeFjSwAAJjrjEb0adoSjnUQLqbw7xwb2jLDgAEAQADAgADeQADqBAGAAEZBA")
