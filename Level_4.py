...
class Level_4_Handler:
    def __init__(self, player_id, message, bot):
        global scenes
        global tasks
        path = os.getcwd() + "/JsonScenes"
        with open(path + "/Tasks_Level_4.json", encoding="utf-8") as f:
            tasks = json.loads(f.read())
        with open(path + "/Scenes_Level_4.json", encoding="utf-8") as f:
    ...
    def handle_start(self):
        ...
        self.bot.send_photo(self.message.chat.id, "AgACAgIAAxkDAAIFzV7NAtkScK7W8GhMJrVSOx9TizUxAAJkrjEb0adoSmxAsYWUrhr6bq69ki4AAwEAAwIAA3kAA-t5AgABGQQ")
